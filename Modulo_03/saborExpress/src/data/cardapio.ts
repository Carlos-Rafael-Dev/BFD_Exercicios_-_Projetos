...
export const cardapio: Prato[] = [
  ...
  new Prato(
    ...
    31.5,
    CategoriaPrato.MASSAS,
    [INGREDIENTES_BASE.penneIntegral, INGREDIENTES_BASE.molhoDeIogurte]
  ),
  ...
  new Prato(
    ...
    33.9,
    CategoriaPrato.MASSAS,
    [INGREDIENTES_BASE.tagliatelle, INGREDIENTES_BASE.cogumelo]
  ),
  ...
  new Prato(
    ...
    28.9,
    CategoriaPrato.MASSAS,
    [INGREDIENTES_BASE.massaIntegral, INGREDIENTES_BASE.cenouraRalada]
  ),
  ...
  new Prato(
    ...
    [INGREDIENTES_BASE.couve, INGREDIENTES_BASE.limao, INGREDIENTES_BASE.agua]
  ),
  ...
  new Prato(
    ...
    14.5,
    CategoriaPrato.BEBIDAS,
    [INGREDIENTES_BASE.frutasVermelhas, INGREDIENTES_BASE.agua]
  ),
  ...
  new Prato(
    ...
    15.9,
    CategoriaPrato.BEBIDAS,
    [INGREDIENTES_BASE.whey, INGREDIENTES_BASE.banana, INGREDIENTES_BASE.agua]
  ),
  ...
  new Prato(
    ...
    11.9,
    CategoriaPrato.BEBIDAS,
    [INGREDIENTES_BASE.hibisco, INGREDIENTES_BASE.limao, INGREDIENTES_BASE.agua]
  ),
  ...
  new Prato(
    ...
    9.9,
    CategoriaPrato.BEBIDAS,
    [INGREDIENTES_BASE.agua, INGREDIENTES_BASE.limao, INGREDIENTES_BASE.hortela]
  ),
  ...
  new Prato(
    ...
    13.9,
    CategoriaPrato.SOBREMESAS,
    [INGREDIENTES_BASE.chia, INGREDIENTES_BASE.frutasVermelhas]
  ),
  ...
  new Prato(
    ...
    13.5,
    CategoriaPrato.SOBREMESAS,
    [INGREDIENTES_BASE.amendoim, INGREDIENTES_BASE.whey]
  ),
...
cardapio.push(
  new Combo(
    ...
    [],
    cardapio.filter(
      (Prato) => Prato.getId() === "p3" || Prato.getId() === "p12"
    )
  ),
  ...
  new Combo(
    ...
    [],
    cardapio.filter(
      (Prato) => Prato.getId() === "p6" || Prato.getId() === "p13"
    )
  ),
  ...
  new Combo(
    ...
    [],
    cardapio.filter(
      (Prato) => Prato.getId() === "p13" || Prato.getId() === "p18"
    )
  ),
